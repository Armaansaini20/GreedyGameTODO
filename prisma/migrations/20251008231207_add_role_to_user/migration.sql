...
INSERT INTO "new_Todo" ("completed", "createdAt", "description", "id", "scheduledAt", "title", "updatedAt", "userId") SELECT "completed", "createdAt", "description", "id", "scheduledAt", "title", "updatedAt", "userId" FROM "Todo";
DROP TABLE "Todo";
